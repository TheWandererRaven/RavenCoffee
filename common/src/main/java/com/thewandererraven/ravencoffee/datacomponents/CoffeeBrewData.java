...
public record CoffeeBrewData(
    ...
    public static final CoffeeBrewData EMPTY = new CoffeeBrewData(BrewItem.BrewVariant.BASIC, 0, new ArrayList<>());
    public static final CoffeeBrewData BROKEN = new CoffeeBrewData(BrewItem.BrewVariant.BROKEN, 0, new ArrayList<>());
}
